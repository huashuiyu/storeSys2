...
<div class="wrapper">
    <header class="header">
        ...
        <tr>
            ...
            <form action="update_Reg">
                仓库名&nbsp;&nbsp;&nbsp;&nbsp;：<input type="text"  value="<%=request.getParameter("storeName")%>" name="store.storeName"><br>
                仓库管理者：<input type="text" value="<%=request.getParameter("storeManager")%>" name="store.storeManager"><br><br><br>
