...
<section class="scene3d">
    ...
    <div>
        <form method="post" action="buy">
            <s:token></s:token>
            <input type="hidden" name="item.basePrice" value="<%=basePrice%>">
            <input type="hidden" name="item.outPrice" value="<%=outPrice%>">
            <input type="hidden" name="item.storeName" value="<%=storeName%>">
            <input type="hidden" id="num" name="item.number" value="<%=num%>">
            <input type="hidden" name="item.itemId" value="<%=itemId%>">
            <br>
            商品<input type="text" name="item.item" value="<%=item%>"><br>
            <br>
            数量<input type="text" name="n" id="number" onblur="x()"><br>
            <p id="p"></p>
            <br/>
